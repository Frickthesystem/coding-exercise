...
* ð **Online book version:** All of course materials are available in a readable online book at [learnpytorch.io](https://learnpytorch.io).
* ð¥ **First five sections on YouTube:** Learn Pytorch in a day by watching the [first 25-hours of material](https://youtu.be/Z_ikDlimN6A).
* ð¬ **Course focus:** code, code, code, experiment, experiment, experiment.
* ðââï¸ **Teaching style:** [https://sive.rs/kimo](https://sive.rs/kimo).
* ð¤ **Ask a question:** See the [GitHub Discussions page](https://github.com/mrdbourke/pytorch-deep-learning/discussions) for existing questions/ask your own.
...
* 6 July 2022 - course launched on ZTM Academy with videos for sections 00-07! ð - https://dbourke.link/ZTMPyTorch 
...
* 16 May 2022 - recorded 10 videos for section 05, finish videos for section 05 â
...
* 19 Oct 2021 - Start repo ð¥, add fundamentals notebook draft v0
